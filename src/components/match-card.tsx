...
import LoadingMatchCard from "./loader/loading-matchcard";

interface propType {
	fixture: Fixture;
}
const MatchCard: FC<propType> = ({fixture}) => {
	if (fixture == undefined || fixture == null) return <LoadingMatchCard />;
	return (
		<div className="grid grid-cols-3 w-full bg-generic-200 rounded-lg p-4 items-center justify-center hover:bg-generic-100 border-solid border-[1px] border-transparent/10 hover:border-white/10 transition-colors">
